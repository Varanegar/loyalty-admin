(function () {
    ...
    angular
           .module('membersApp')
           .controller('groupPermissionsController', groupPermissionsController);

    groupPermissionsController.$inject = ['$scope', '$location', '$rootScope', 'toaster', 'callApi'];

    function groupPermissionsController($scope, $location, $rootScope, toaster, callApi) {
